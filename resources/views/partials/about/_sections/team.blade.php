<section class="dark-bg-2">
    ...
    <div class="flex-container container bottom-padding-60 top-padding-120">
        <!-- <div class="four-columns bottom-padding-60"></div> -->
        <!-- Meet The CEO start -->
        <div class="columns-12-md bottom-padding-60">
            ...
            <div class="columns-5-md bottom-padding-60">
                <a data-animation-container href="" class="content-left-right-margin-10 hover-box pointer-large d-block">
                    <div data-animation-child style="min-height: 450px; " class="overlay-anim-box2 overlay-dark-bg-1 team-img-box" data-animation="overlay-anim2">
